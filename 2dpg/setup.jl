...
"""
    m = ModelSetup(f, ξVariation, L, nξ, nσ, ξ, σ, H_func, Hx_func, ν_func, κ_func, N_func, Δt)
...
function ModelSetup2DPG(f::Float64, ξVariation::Bool, L::Float64, nξ::Int64, nσ::Int64, coords::String, 
                    ...
                    ν_func::Function, κ_func::Function, N_func::Function, Δt::Real)
    # evaluate functions 
    H = @. H_func(ξ)
    Hx = @. Hx_func(ξ)
    ν = zeros(nξ, nσ)
    ...
    return ModelSetup2DPG(f, ξVariation, L, nξ, nσ, coords, periodic, ξ, σ, x, z, H, Hx, ν, κ, N, Δt)
end

"""
    m = ModelSetup(f, ξVariation, L, nξ, nσ, coords, periodic, ξ, σ, x, z, H, Hx, ν, κ, N Δt)
...
function ModelSetup2DPG(f::Float64, ξVariation::Bool, L::Float64, nξ::Int64, nσ::Int64, coords::String, 
                    ...
                    H::Array{Float64,1}, Hx::Array{Float64,1}, ν::Array{Float64,2}, κ::Array{Float64,2}, N::Array{Float64,2}, Δt::Real)
    ...
    return ModelSetup2DPG(f, ξVariation, L, nξ, nσ, coords, periodic, ξ, σ, x, z, H, Hx, ν, κ, N, Δt, Dξ, Dσ, D, inversionLHSs, χ_U)
end