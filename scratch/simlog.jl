...
2D run with ε² = 1e-4, f = 1, γ = 1/4, μϱ = 1e-4, Δt = 1e-4, T = 5e-2 and
direct solvers to compare with sim035 (3D f-plane run).

###############################################################################

sim045

Diffusion only run in 3D with ε² = 1e-4, γ = 1/4, μϱ = 1e-4, Δt = 1e-4,
T = 5e-2.
...
Same as sim045 but in 2D.

###############################################################################

sim047

Same as sim046 but at higher resolution (h = 0.005)

###############################################################################

sim048

Diffusion only run in 3D with ε² = 1e-4, γ = 0, μϱ = 1e-4, Δt = 1e-4,
T = 5e-2. (Same as sim045 but with γ = 0).
