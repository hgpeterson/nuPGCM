...
for a ∈ ax
    ...
    a.set_xticks([0, 1])
    a.set_yticks([])
    a.text(-0.1, 0, s=L"z", size=10)
end
ax[1].set_xticklabels([L"0", L"U/H"], size=10)
ax[2].set_xticklabels([L"0", L"V/H"], size=10)
ax[1].plot(ux_Ux, z)
ax[1].plot(uy_Ux, z)
ax[2].plot(ux_Uy, z)
ax[2].plot(uy_Uy, z)
# ax[1].text(1.05, -0.90, s=L"u", size=12)
# ax[1].text(0.10, -0.95, s=L"v", size=12)
# ax[2].text(-0.3, -0.95, s=L"u", size=12)
# ax[2].text(1.05, -0.90, s=L"v", size=12)
...
#     ax.set_xticks([0])
#     ax.set_yticks([])
#     ax.text(-2e-3, 0, s=L"z", size=10)
#     return ax
# end
# ax = plotsetup()
# ax.plot(ux_b, z, "C0", label=L"u")
# ax.plot(uy_b, z, "C1", label=L"v")
# ax.legend(fontsize=12)
# ax.set_xlim(-1.5e-2, 7e-3)
# # ax.text(3e-3, -1.9e3, s=L"u", size=12)
# # ax.text(-1e-2, -1.75e3, s=L"v", size=12)
