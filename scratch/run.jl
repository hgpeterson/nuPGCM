...
inversion_toolkit = InversionToolkit(A_inversion, P_inversion, B_inversion; atol=1e-6, rtol=1e-6)
...
# plot_profiles(u, v, w, b, N²; x=0.5, y=0.0, fname="$out_dir/images/profiles_$mesh_name.png")
# plot_slice(u, b, N²; bbox=[0, -1, 1, 0], y=0.0, cb_label=L"Zonal flow $u$",      fname="$out_dir/images/u_$mesh_name.png")
# plot_slice(v, b, N²; bbox=[0, -1, 1, 0], y=0.0, cb_label=L"Meridional flow $v$", fname="$out_dir/images/v_$mesh_name.png")
# plot_slice(w, b, N²; bbox=[0, -1, 1, 0], y=0.0, cb_label=L"Vertical flow $w$",   fname="$out_dir/images/w_$mesh_name.png")
# plot_slice(b, b, N²; bbox=[0, -1, 1, 0], y=0.0, cb_label=L"Buoyancy perturbation $b'$",   fname="$out_dir/images/b_$mesh_name.png")

# plot_slice(u, b, N²; bbox=[0, -α, 1, 0], y=0.0, cb_label=L"Zonal flow $u$",      fname="$out_dir/images/u_channel.png")
# plot_slice(v, b, N²; bbox=[0, -α, 1, 0], y=0.0, cb_label=L"Meridional flow $v$", fname="$out_dir/images/v_channel.png")
# plot_slice(w, b, N²; bbox=[0, -α, 1, 0], y=0.0, cb_label=L"Vertical flow $w$",   fname="$out_dir/images/w_channel.png")
# plot_slice(b, b, N²; bbox=[0, -α, 1, 0], y=0.0, cb_label=L"Buoyancy perturbation $b'$", fname="$out_dir/images/b_channel.png")
# plot_slice(u, v, b, N²; bbox=[0, -0.25, 1, 0.25], z=0.0, cb_label=L"Horizontal speed $\sqrt{u^2 + v^2}$", fname="$out_dir/images/u_sfc.png")
...
plot_slice(u, v, b, N²; bbox=[0, -1, 1, 1], z=0.0, cb_label=L"Horizontal speed $\sqrt{u^2 + v^2}$", fname="$out_dir/images/u_sfc_basin.png")
